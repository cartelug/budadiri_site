 ...
 * projection layer, the seam and the two stamps. Where the device can
 * afford it, scroll pins the frame and writes that value; everywhere
 * else the same value comes from normal scroll position or from the
 * range control, which is always live — so the comparison never
 * depends on a scroll trick.
 */
